...
export class ApiService {
  ...
  getCurrency(currency: string){
    //return this.http.get<any>(`https://api.coingecko.com/api/v3/coins/markets?vs_currency=${event ? event : this.selectedCurrency}&order=market_cap_desc&sparkline=false`);
